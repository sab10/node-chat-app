...
function scrollToBottom () {
  ...
  var newMessage = messages.children('li:last-child'); // this take the li items in the messages variable and extract the last one
  // Heights
...
socket.on('connect', function () {
  ...
  socket.emit('join', params, function (error) {
    if(error) {
      ...
      console.log('No errors in the parameters');
    }
  });
});
